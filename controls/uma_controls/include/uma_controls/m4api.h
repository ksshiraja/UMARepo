...
#ifndef UMA_CONTROLS_M4API_H
#define UMA_CONTROLS_M4API_H
...
/* UMA function: Send the diagnostic information to publish to ros */
void m4ReturnDiagInfo(char *buf, int *returnSize, struct kvPair *diagInfo);

#ifdef __cplusplus
}
#endif  // __cplusplus

#endif  // UMA_CONTROLS_M4API_H
